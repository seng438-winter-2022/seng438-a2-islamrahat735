	 ...
	 @Test
	  ...
	  //Method double calculateRowTotal(Values2D data, int row, int[] valCols) 
	    ...
	    public void testAValidInputUsingEdgeColumnsForMethodCalculateRowTotal() //Find Total Row Value using the first and last column
	    {
	        ...
	        mock1.checking(new Expectations() {
	            {
	                ...
	                will(returnValue(6.9));//returns the value
	                allowing(value1).getValue(0, 1);// setting up the mock of object
	                will(returnValue(1.3));//returns the value
	                allowing(value1).getValue(0, 2);// setting up the mock of object
	                will(returnValue(134.6));//returns the value
	        ...
	        assertEquals("This test is for a valid input for a valid input for the calculateRowTotal method", 7.9, result, .000000001d);//verify
	    }
	    ...
	    public void testAValidInputUsingMiddleColumnsForMethodCalculateRowTotal() //Find Total Row Value using the middle columns
	    {
	        ...
	        double result = DataUtilities.calculateRowTotal(value1, 0, valCols);// call the calculateRowTotal method and passed the variable data and row
	        assertEquals("This test is for a valid input for a valid input for the calculateRowTotal method", 135.9, result, .000000001d);//verify
	    }
